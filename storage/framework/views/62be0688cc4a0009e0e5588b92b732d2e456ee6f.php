...
<div class="page-content" data-page="<?php echo e($page->id); ?>">
    ...
    <?php $__currentLoopData = $page->getContent(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
        <div class="row">
...
<?php if(!Auth::guest()): ?>
    <script type="text/javascript">
        ...
        function reloadPageContent() {
            ...
            $.get('/cms/pages/<?php echo e($page->id); ?>/content', function(content) {
                if (content.length == 0) {
