...
<div class="modal fade" tabindex="-1" role="dialog" id="uploadMediaModal" aria-labelledby="uploadMediaModal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <?php echo Former::open()->action( URL::route("media.store") )->method('post')->enctype("multipart/form-data")->class('p-t-15')->role('form')->id('media-form'); ?>
                ...
                <div class="modal-footer">
                    ...
                    <?php echo Former::submit('Opslaan en toevoegen')->disabled(true)->class('btn btn-success'); ?>
            ...
            $.ajax({
                ...
                success: function( data ) {
                    if(data.status == 'success') {
                        ...
                        $('#spinner').show();
                        swal(
                          'Afbeeldingen succesvol geupload!',
                          '',
                          'success'
                        );
